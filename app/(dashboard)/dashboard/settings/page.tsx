...
const SettingsPage = () => {
  return (
    <div className="p-4 h-screen">
      <h1 className="text-gray-950 font-normal text-[22px]">Settings</h1>
      <div className="flex items-center justify-between mt-7 bg-white rounded-md max-h-[72px] md:px-[25px]">
