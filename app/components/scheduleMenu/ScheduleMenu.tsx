  ...
  return (
    <div className="p-4 px-6 rounded-md bg-white my-4 shadow-md flex items-center justify-between">
      ...
      <div className="flex items-center justify-between gap-6">
        <ToogleAppointmentButton className="md:w-10 w-8 h-8 md:h-10 rounded-md  border  border-gray-400 flex items-center justify-center">
          <LuPlus title="Add Schedule" size={25} className="font-bold" />
        </ToogleAppointmentButton>
        <span className="w-10 h-10 md:flex  rounded-md  border border-gray-400 hidden items-center justify-center">
          <LuSearch size={25} className="font-bold" />
        </span>
        <span className="w-10 h-10 rounded-md md:flex  border border-gray-400 hidden items-center justify-center">
          <LuFilter size={25} className="font-bold" />
        </span>
        <span className="w-10 h-10 rounded-md  border md:flex border-gray-400 hidden items-center justify-center">
